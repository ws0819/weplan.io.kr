...
var filter_DashboardService_GetDashboard_0 = &utilities.DoubleArray{Encoding: map[string]int{"meeting_id": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
...
func RegisterDashboardServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DashboardServiceServer) error {
	mux.Handle(http.MethodGet, pattern_DashboardService_GetDashboard_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.DashboardService/GetDashboard", runtime.WithHTTPPathPattern("/api/weplan/dashboard/{meeting_id}"))
		if err != nil {
...
func RegisterDashboardServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DashboardServiceClient) error {
	mux.Handle(http.MethodGet, pattern_DashboardService_GetDashboard_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/pb.DashboardService/GetDashboard", runtime.WithHTTPPathPattern("/api/weplan/dashboard/{meeting_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_DashboardService_GetDashboard_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "weplan", "dashboard", "meeting_id"}, ""))
)
