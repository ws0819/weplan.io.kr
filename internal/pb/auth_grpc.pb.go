...
const (
	...
	AuthService_KakaoLogin_FullMethodName  = "/pb.AuthService/KakaoLogin"
)
...
type AuthServiceClient interface {
	...
	KakaoLogin(ctx context.Context, in *KakaoLoginRequest, opts ...grpc.CallOption) (*LoginResponse, error)
}
...
func (c *authServiceClient) KakaoLogin(ctx context.Context, in *KakaoLoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LoginResponse)
	err := c.cc.Invoke(ctx, AuthService_KakaoLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	KakaoLogin(context.Context, *KakaoLoginRequest) (*LoginResponse, error)
...
func (UnimplementedAuthServiceServer) KakaoLogin(context.Context, *KakaoLoginRequest) (*LoginResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method KakaoLogin not implemented")
}
...
func _AuthService_KakaoLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KakaoLoginRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).KakaoLogin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_KakaoLogin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).KakaoLogin(ctx, req.(*KakaoLoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_KakaoLogin_Handler,
		},
	},
